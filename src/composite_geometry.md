...
It can be applied to both simple geometric shapes (in which case it mimicks the [`invert` keyword](geometry.md#inverting-the-selection)) and composite shapes (in which case it inverts the entire geometry).
...
For instance, here we create a region consisting of two concentring rings.
